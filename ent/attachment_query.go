...
func (aq *AttachmentQuery) QueryOwner() *EnvelopeQuery {
	query := (&EnvelopeClient{config: aq.config}).Query()
...
func (aq *AttachmentQuery) WithOwner(opts ...func(*EnvelopeQuery)) *AttachmentQuery {
	query := (&EnvelopeClient{config: aq.config}).Query()
...
func (aq *AttachmentQuery) loadOwner(ctx context.Context, query *EnvelopeQuery, nodes []*Attachment, init func(*Attachment), assign func(*Attachment, *Envelope)) error {
